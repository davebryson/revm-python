...
from bankreserve.model import BankModel
...
def person_portrayal(agent):
    ...
    # update portrayal characteristics for each Consumer agent
...
model_params = {
    "init_people": mesa.visualization.Slider(
        "Number of Agents", 25, 1, 200, description="Initial Number of Agents"
    ),
    "rich_threshold": mesa.visualization.Slider(
        "Rich threshold in Eth",
        10,
        1,
        20,
        description="Value the indicates wealth",
    ),
